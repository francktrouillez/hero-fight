class GameController {
  /* Class that control the whole game. It manages the different states of the game and adapt the view accordingly to the game.*/
  ...
  _animation_fighting_attack(fps) {
  ...
  _animation_fighting_monster(fps, opponent) {
    if (opponent instanceof Slime) {
