class TreeRender extends RenderObject {

  constructor(gl, program, camera, lights_list, category) {

    var uniform_map = {}

    super(
      new ComplexObject(gl, obj_files["./src/view/assets/models/Tree/Tree" + category + ".obj"]),
      program,
      camera,
      uniform_map
    )
